    ...
    >
      {locating ? (
        ...
        <svg className="locate-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <line className="locate-icon-line" x1="12" y1="1" x2="12" y2="4" strokeWidth="1.8" strokeLinecap="round"/>
          <line className="locate-icon-line" x1="12" y1="20" x2="12" y2="23" strokeWidth="1.8" strokeLinecap="round"/>
          <line className="locate-icon-line" x1="1" y1="12" x2="4" y2="12" strokeWidth="1.8" strokeLinecap="round"/>
          <line className="locate-icon-line" x1="20" y1="12" x2="23" y2="12" strokeWidth="1.8" strokeLinecap="round"/>
        </svg>
      )}
    </button>
  );
