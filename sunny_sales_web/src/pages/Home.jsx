...
// Estrutura: hero com título e chamadas para ação, secção para vendedores
// e uma fila final de funcionalidades.
    ...
    <div className="home">
      ...
      <section className="home-hero">
        ...
        <p className="home-hero-lead">
          ...
          mapa interativo em tempo real. Apoia o comércio local e vive a praia
          com mais comodidade.
        </p>
